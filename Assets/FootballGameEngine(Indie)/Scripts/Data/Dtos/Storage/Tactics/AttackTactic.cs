using CustomRange = Assets.FootballGameEngine_Indie.Scripts.Utilities.Objects.Range;
...
namespace Assets.FootballGameEngine_Indie_.Scripts.Tactics
{
    ...
    public class AttackTactic : Tactic
    {
        ...
        /// </summary>
        [SerializeField]
        CustomRange _shortPassRange = new CustomRange(5f, 9f);

        [SerializeField]
        AttackTypeEnum _attackType;

        public AttackTypeEnum AttackType { get => _attackType; set => _attackType = value; }
        public CustomRange ShortPassRange { get => _shortPassRange; set => _shortPassRange = value; }
